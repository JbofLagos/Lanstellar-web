...
const transactions = [
  {
    loan_period: "2 months",
    purpose_of_loan: "Office Building",
    asset_collateral: "$23,489",
    amount: "$7,200",
    status: "Overdue",
    date: "Jun 3, 2025 ",
    due: "Due Jun 10, 2026",
        ...
        <CardContent className="text-[13.78px] flex flex-col font-medium w-full justify-center items-center text-[#8C94A6] px-0">
          <Table>
            <TableHeader className="bg-[#F8F8FB] text-[#49576D] border-b border-b-[#E5E5E5] font-medium text-[12.06px]">
              <TableRow>
                <TableHead className="font-medium">Loan Period</TableHead>
                <TableHead className="font-medium">Purpose of loan</TableHead>
                <TableHead className="font-medium">Asset Collateral</TableHead>
